export const ToolTipMap = {
  ...
  못: "턴 시작 시 출혈 1을 주고, 출혈 횟수가 수치만큼 증가. 턴 종료 시 수치가 절반 감소(소수점 버림)",
  주시: "한 턴동안 관통, 타격 속성 스킬로 받는 피해 20% 증가.\n표적이 찍힌 적 처치 시 처치한 아군의 정신력이 10 회복되며, 해당 아군이 N사 광신도면 다음 턴에 광신 1을 얻음",
  갈증: "즉흥 조리 패시브의 회복량이 수치에 비례하여 증가. 패시브 발동 시 전부 소모",
  침잠쇄도:
  ...
  저주: "턴 종료 시 공격 위력 감소 1, 수비 위력 감소 1, 공격 레벨 감소 2, 방어 레벨 감소 2 중 무작위 1개의 효과를 얻고, 수치 1 감소",
  "결투 선포":
  ...
  구더기:
    "턴 종료 시 수치만큼 탐식 피해를 받고, 출혈 횟수가 1 증가한 뒤 수치 1 감소",
  "차원 균열": "턴 종료 시 파열 횟수가 수치만큼 증가한 뒤 이 효과 소멸",
  "방출 전류":
    "피격 시 공격자의 충전 횟수 1 증가. 우울 속성으로 피격 시 자신의 파열 횟수 1 증가. 이후 수치 1 감소",
